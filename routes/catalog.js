...
console.log("book_controller:", {
    index: book_controller.index,
    book_create_get: book_controller.book_create_get,
    book_create_post: book_controller.book_create_post,
    book_delete_get: book_controller.book_delete_get,
    book_detail: book_controller.book_detail,
    book_list: book_controller.book_list,
});
